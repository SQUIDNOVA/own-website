    ...
    <footer className=" bg-darkblue text-white/80 ">
      <div className=" flex flex-col lg:flex-row p-4 sm:p-6 lg:p-[1%] gap-6 lg:gap-0  ">
        <div className=" w-full lg:w-1/2 ">
          ...
          <p className=" text-sm sm:text-base lg:text-lg ml-[2%] mt-2 ">
            We are Squidnova,Our mission is to provide the best services to our
            clients.
          </p>
          <p className=" text-sm sm:text-base lg:text-lg ml-[2%] mt-2 ">
        ...
        <div className=" w-full lg:w-1/2 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-4 ">
          ...
          <div className=" col-span-2 sm:col-span-1 flex flex-col gap-2 sm:gap-3 ">
            ...
            <ol className=" flex flex-col gap-1 text-sm sm:text-base ">
              <li>
                <a href="mailto:squidnova04@gmail.com" className="break-all">
                  squidnova04@gmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/918903500842" target="_blank">
                  +91 8903500842
                </a>
              </li>
              <li>
                <a
                  href="https://maps.app.goo.gl/GJ1LjfewSJgcu2pW6"
                  target="_blank"
                >
                  coimbatore - 641021
                </a>
